...
def dung_explore_2(): # This is exploration after puzzle 3
    choices_dict = {1: "Look at the books on the table.",
                    2: "Venture deeper.",
                    3: "Examine the sigils."}
    #Loop only twice and make sure to append the previous option so players don't gain infinite lives, remove the venture deeper option? 
...
def dung_explore_3(): # This is exploration after puzzle 4
    ...
    while True:
        ...
        while True:
            ...
            while(True):
                try:
                    if len(choices_dict) != 1:
                        ...
                        user_choice = int(input("Only one option left: "))
                    if user_choice in choices_dict:
                        break
                    else:
                        print(f"A valid number.")
                except ValueError:
            ...
            if user_choice == 1:
                result = dung_explore_3_choice_1() 

            elif user_choice == 2:
                result = dung_explore_3_choice_2()
                    
            elif user_choice == 3:
                result = dung_explore_3_choice_3()

            elif user_choice == 4:
                result = dung_explore_3_choice_4()
                ...
                if user_side_choice.lower() in coin_sides:
                    ...
                    if user_side_choice.lower() == result:
                        ...
                        if life == 0:
                            ...
                            print(f"Lives left= {life}.")
                            slow_writting("""You guess incorrectly, as the lockbox opens, tendrils of unknown origin steal a orb from your vessel, 
...
def dung_room_3(): # Puzzle 4
    ...
    while True:
        ...
        if user_answer.lower() == "souls":
            cls()
            message = ("\"Yes... the souls of those who fell to the teachings.Akarak mourned for them. \n"
            ...
            life_system(0, 1)
            message = ("The small Akari merely looks at you. \"Perhaps you should learn...\"\n"
